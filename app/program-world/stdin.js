...
/* =====================================================================
   ...
   ⚠️ worker 那侧（pyworker.js）因为会被 Vite 当静态资源**原样拷贝**，不能 import
   本文件，所以它内联了一份等价的常量与编解码函数。改这里的协议时，**必须同步改
   pyworker.js**，否则两端对不上（tests/program-world-worker.test.ts 钉着这条约束）。
   ===================================================================== */
