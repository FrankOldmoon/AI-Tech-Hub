...
class Robot extends Objsim {
  ...
  create_kuka_kr5(){
      ...
      objLoader.load('./3d_models/kuka_kr5/Base.obj', (root) => {
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis1.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.x = 3.14/2;
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis2.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.x = -3.14/2;
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis3.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.x = 3.14/2;
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis4.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.z = -3.14/2;
          root.rotation.x = 3.14/2;
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis5.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.x = 3.14/2;
      ...
      objLoader.load('./3d_models/kuka_kr5/Axis6.obj', (root) => {
          root.scale.set(0.001,0.001,0.001);
          root.rotation.x = 3.14/2;
 ...
 /**
  ...
  create_epson_t6(){
    ...
    objLoader.load('./3d_models/epson_t6/Base.obj', (root) => {
      root.scale.set(0.001,0.001,0.001);
    ...
    objLoader.load('./3d_models/epson_t6/T6Axis1.obj', (root) => {
      root.scale.set(0.001,0.001,0.001);
      root.translateZ(0.2);
      root.rotation.x = 3.14/2;
    ...
    objLoader.load('./3d_models/epson_t6/T6Cable.obj', (root) => {
      root.scale.set(0.001,0.001,0.001);
    ...
    objLoader.load('./3d_models/epson_t6/T6Axis2.obj', (root) => {
      root.scale.set(0.001,0.001,0.001);
      root.rotation.x = 3.14/2;
    ...
    objLoader.load('./3d_models/epson_t6/T6Axis3.obj', (root) => {
      root.scale.set(0.001,0.001,0.001);
      root.rotation.x = 3.14/2;
